# Order: terminal-keyboard

112 x 90 mm, 2 layer(s), verified fab packet
...
1. cart.jlcpcb.com/quote -> **Add gerber file** -> drop `gerbers.zip`
   (layers + size auto-detect; verify 2 layers, 112 x 90 mm).
...
6. Parts-match table: every line should show a matched C-number and stock
   (134/137 lines carry part numbers in this packet). Shortfalls show
