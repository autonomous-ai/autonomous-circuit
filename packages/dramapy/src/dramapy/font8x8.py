"""8x8 monochrome bitmap font (ASCII 0x00-0x7F) for stdlib text rasterization.

Public domain. Data from font8x8 by Daniel Hepper <daniel@hepper.net>
(https://github.com/dhepper/font8x8), based on public-domain IBM VGA fonts
via Marcel Sondaar. Each glyph is 8 bytes, one byte per row (top to bottom);
within a byte the least-significant bit is the LEFTMOST pixel.
"""

from __future__ import annotations

FONT_8X8_BASIC: tuple[tuple[int, ...], ...] = (
