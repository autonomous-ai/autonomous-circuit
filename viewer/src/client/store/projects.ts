// Project library state. Backed by the `project_*` commands from
// docs/video-interfaces.md §2. The store deliberately stays small —
// catalog state lives in store/catalog.ts.
