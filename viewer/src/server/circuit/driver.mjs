...
export const IMPLEMENT_SYSTEM_PROMPT = [
  ...
  "blocks + glue only). Synchronize exactly the selected golden blocks with",
  "the circuitcode snapshot helper so golden-blocks.lock.json exists; never",
  "copy or hand-edit an unlocked blocks/ tree. Lock parts with the parts-book",
  "skill when the BOM changes, then run the generator",
