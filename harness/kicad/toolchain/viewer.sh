...
# and refuses every chat_* command — the conversation lives in the Harness terminal. For a
# kicad-native project it shows the native SVG previews, the GLB, the reports and the packet
# the publisher wrote under boards/, and reloads on every change.
set -euo pipefail
...
export CIRCUIT_DEFAULT_ENGINE="kicad-native"
