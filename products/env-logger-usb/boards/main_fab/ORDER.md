# Order: env-logger-usb

99.6 x 64 mm, 2 layer(s), verified fab packet
...
1. cart.jlcpcb.com/quote -> **Add gerber file** -> drop `gerbers.zip`
   (layers + size auto-detect; verify 2 layers, 99.6 x 64 mm).
...
6. Parts-match table: every line should show a matched C-number and stock
   (18/23 lines carry part numbers in this packet). Shortfalls show
