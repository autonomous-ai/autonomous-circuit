# Order: rgb-lamp-controller

84.9 x 68.6 mm, 2 layer(s), verified fab packet
...
1. cart.jlcpcb.com/quote -> **Add gerber file** -> drop `gerbers.zip`
   (layers + size auto-detect; verify 2 layers, 84.9 x 68.6 mm).
...
6. Parts-match table: every line should show a matched C-number and stock
   (18/24 lines carry part numbers in this packet). Shortfalls show
